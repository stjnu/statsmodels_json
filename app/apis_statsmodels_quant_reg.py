...
import json
apis_statsmodels_quant_reg = Blueprint('apis_statsmodels_quant_reg', __name__)

@apis_statsmodels_quant_reg.route("/")



def fn_apis_statsmodels_quant_reg():
    import numpy as np
